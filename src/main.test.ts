...
const professor1: Professor = { id: 1, name: "Stephen Doy", department: "Math" };
...
const course1: Course = { id: 1, name: "Math 201", type: "Lecture" };
const course2: Course = { id: 2, name: "Physics 201", type: "Seminar" };
...
describe("Schedule Management", () => {
  ...
  test("should find available classrooms", () => {
    ...
    expect(availableClassrooms).not.toContain("201");
    expect(availableClassrooms).toContain("202");
  });
  ...
  test("should return classroom utilization", () => {
    ...
    const utilization = getClassroomUtilization("201");
  ...
  test("should reassign classroom", () => {
    addLesson(lesson1);
    const result = reassingClassroom(1, "202");
  ...
  test("should not reassign classroom", () => {
    addLesson(lesson1);
    addLesson({ ...lesson1, classroomNumber: "202", professorId: 2 });
    const result = reassingClassroom(1, "202");
    expect(result).toBe(false);
  });
